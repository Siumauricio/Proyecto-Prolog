...
estudiante(3057, 1, [his101, soc101, ccc107]).
...
estudiante(3100, 0, [esp103, mat101]).
estudiante(3101, 1, [fis201, mat101]).
estudiante(3102, 0, [esp103, mat101]).
estudiante(3103, 0, [esp103, mat101]).
estudiante(3104, 0, [fis201, his101, ccc107]).
estudiante(3105, 1, [soc101, lcc104]).
estudiante(3106, 0, [tel201, mat101]).
...
estudiante(3113, 1, [esp103]).
estudiante(3114, 0, [soc101, mat101]).
...
%Funcion 1
clist([], 1).
clist([_|L], N) :- length(L, O), N is O+2.
